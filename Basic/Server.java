	...
	public static void main(String args[]) {
		...
		while (true) {
			try {
				...
				String message = input_stream.readLine();	//Reads input from user
				System.out.println(message);	//posts message
				output_stream.append("#statusPosted"); //sends back statusPosted message
